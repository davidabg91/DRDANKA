...
export const STORE_REGISTERS: RegisterDef[] = [
  {
    ...
    fillWhen:
      "Не е необходимо да попълвате този списък ръчно — той се създава автоматично. Когато сканирате фактура или стокова разписка в „Дневник за входящ контрол на храните“ (2), ИИ разчита доставчика, адреса и телефона от документа и вида на доставените храни и ги вписва тук. Вашата задача е само да прегледате данните и да поправите евентуални грешки при разчитането.",
    frequency: "permanent",
    period: "all",
    kind: "rows",
    columns: [
    ...
    infoPanels: [
      {
        ...
        items: [
          ...
          "Видът на доставките се допълва от храните, приети от съответния доставчик.",
