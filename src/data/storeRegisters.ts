...
export const STORE_REGISTERS: RegisterDef[] = [
  {
    ...
    fillWhen:
      "Не е необходимо да попълвате този списък ръчно — той се създава автоматично. Когато сканирате фактура или стокова разписка в „Дневник за входящ контрол на храните“ (2), ИИ разчита доставчика, адреса и телефона от документа, преглежда всички продукти и сам определя вида на доставките (напр. „мляко и млечни продукти“), след което ги вписва тук. Вашата задача е само да прегледате данните и да поправите евентуални грешки при разчитането.",
    frequency: "permanent",
    period: "all",
    kind: "rows",
    columns: [
    ...
    infoPanels: [
      {
        title: "Автоматично попълване от входящия контрол",
        items: [
          "Сканирайте фактурата/стоковата разписка в дневник 2 „Входящ контрол“ — ИИ разчита данните от документа.",
          "Доставчикът се добавя тук автоматично, ако още не е в списъка.",
          "Адресът и телефонът се вземат от документа, когато са изписани върху него.",
          "Видът на доставките се определя от ИИ по продуктите в документа и се записва като група храни — напр. „мляко и млечни продукти“, „месо и месни продукти“, „плодове и зеленчуци“.",
          "При следваща доставка с други продукти новите групи се добавят, без да се дублират.",
          "Вече попълнени от Вас данни не се презаписват — допълват се само празните полета.",
          "Прегледайте вписаното и коригирайте, ако ИИ е разчел нещо грешно.",
        ],
      },
    ],
  },
...
export const HOT_POINT_REGISTERS: RegisterDef[] = [
  ...
  },
  {
    ...
    fillWhen: "Попълва се ежедневно при зареждане — за всяко изделие се вписват срок на годност и партиден номер. При избор на изделие системата попълва автоматично срока и партидата от най-скорошната съответна доставка в „Дневник за входящ контрол“ (2).",
    frequency: "daily",
    period: "month",
    kind: "rows",
    columns: [
