        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            },
            {
              ...
              desc: "Най-честите грешки при воденето на записи по ДПХП и НАССР и как да ги избегнете (базирано на реални несъответствия)."
            },
            {
              icon: Users,
...
export const haccpPrakticheskaSistema: LibraryMaterial = {
  ...
  metaDescription:
    "Онлайн практическо обучение по ДПХП и НАССР за хранителни обекти. Изгради реално работеща система и намали риска от глоби при проверки от ОДБХ.",
};
