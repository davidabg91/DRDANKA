...
export const registraciaProizvodstvoTargovia: LibraryMaterial = {
  ...
  tagline:
    "Запис от практическо онлайн обучение: какво трябва да проверите преди да наемете помещение, да започнете ремонт или да купите оборудване, за да избегнете скъпи грешки.",
  priceEur: 27,
  originalPriceEur: 54,
  type: "video",
  category: "training",
