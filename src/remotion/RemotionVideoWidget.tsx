  ...
  return (
    <div className="relative group">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/8 bg-gradient-to-br from-[#0a1f17] via-[#0d2b1c] to-[#081410] flex flex-col">
        ...
        <div className="px-6 pb-6 flex flex-col justify-end space-y-3 shrink-0 bg-gradient-to-t from-[#081410] to-transparent relative z-10 -mt-8">
          <div className="text-center">
            <h3 className="font-serif text-base sm:text-lg font-bold text-white leading-tight">
              Абонамент
            </h3>
            <h3 className="font-serif text-xl sm:text-2xl font-bold text-brand-gold leading-tight">
              „БАБХ Спокойствие“
            </h3>
          </div>
