...
3. Номер на документа/фактурата (documentNumber) - например номер на фактура или касов бон.
4. Всички хранителни продукти/стоки от списъка (items) със следните детайли:
