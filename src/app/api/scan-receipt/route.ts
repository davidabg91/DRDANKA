...
6. Вид на доставките (supplierGoods) - прегледай всички продукти в документа и определи в кои групи храни попадат. Върни кратко описание на групите, разделени със запетая, а НЕ списък на отделните продукти.
   Използвай групи като: месо и месни продукти, птиче месо, риба и рибни продукти, мляко и млечни продукти, хляб и хлебни изделия, тестени и сладкарски изделия, плодове и зеленчуци, замразени храни, консерви, подправки и добавки, безалкохолни напитки, алкохолни напитки, яйца, зърнени и бобови храни, захарни изделия, олио и мазнини, нехранителни стоки (почистващи препарати, опаковки).
   Пример: ако документът съдържа кисело мляко, сирене и масло → "мляко и млечни продукти". Ако съдържа кайма, кебапчета и пилешко филе → "месо и месни продукти, птиче месо".
7. Всички хранителни продукти/стоки от списъка (items) със следните детайли:
